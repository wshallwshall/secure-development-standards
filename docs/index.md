...
**Cost/Benefit.** Adoption is per document and each says its own price; nothing here is a product,
a scanner, or a service, and nothing is sold. You end up maintaining the text yourself, and citing
the model document's permanent rule identifiers in your own deviations register. The set also
publishes the figures that did not survive checking, named as claims to stop repeating.
