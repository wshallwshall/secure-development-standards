...
|---|---|---|---|
| **The CISO summary** -- two pages, start here if you are deciding rather than adopting | [page](CISO-SUMMARY.md) | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/CISO-SUMMARY.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/CISO-SUMMARY.docx) |
| **Which security standards apply to you** -- routes your situation to the documents worth your attention, and to what to check next | [page](WHICH-STANDARDS-APPLY.md) | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/WHICH-STANDARDS-APPLY.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/WHICH-STANDARDS-APPLY.docx) |
| **What to have ready when a buyer asks** -- the diligence packet from the producing side: what to have on the shelf before the first call, and what each artifact proves | [page](DILIGENCE-PACKET.md) | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/DILIGENCE-PACKET.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/DILIGENCE-PACKET.docx) |
| **Security standards reference** -- one row per document, and the reasoning behind the cuts they are sorted on | [page](STANDARDS-REFERENCE.md) | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/STANDARDS-REFERENCE.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/STANDARDS-REFERENCE.docx) |
| **How to adopt these** -- what to do with the rest of this section: five artifacts that either exist or do not, and the order to build them in | [page](ADOPTING-THESE.md) | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/ADOPTING-THESE.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/ADOPTING-THESE.docx) |
| **Automated compliance in CI** -- which of your rules a pipeline can enforce, which it can only report on, and what that is worth | [page](CI-ENFORCEMENT.md) | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/CI-ENFORCEMENT.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/CI-ENFORCEMENT.docx) |
| **AI-assisted development** -- the rigor dial: how much process a given change actually needs, and the floor that never scales down | [page](AI-ASSISTED-DEVELOPMENT.md) | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/AI-ASSISTED-DEVELOPMENT.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/AI-ASSISTED-DEVELOPMENT.docx) |
| **Dependency integrity** -- trusting code you did not write, and controlling what you publish | [page](DEPENDENCY-INTEGRITY.md) | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/DEPENDENCY-INTEGRITY.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/DEPENDENCY-INTEGRITY.docx) |
| **Human review of code** -- how much of it a human must read | [page](REVIEW-DEPTH.md) | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/REVIEW-DEPTH.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/REVIEW-DEPTH.docx) |
| **Code quality** -- is this good, or is it filler that looks finished: eleven signals, and which of them may decide a verdict | [page](CODE-QUALITY.md) | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/CODE-QUALITY.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/CODE-QUALITY.docx) |
| **Secure development** -- a starting point for your own standard, covering the process a build must satisfy from the threat model to the release gate, and what you may claim once it does | [page](SECURE-DEVELOPMENT.md) | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/SECURE-DEVELOPMENT.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/SECURE-DEVELOPMENT.docx) |
| **Use OWASP ASVS 5.0** -- assessing a codebase against a large standard | [page](../ASVS-ASSESSMENT.md) | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/ASVS-ASSESSMENT.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/ASVS-ASSESSMENT.docx) |
| This overview | -- | [.md](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/OVERVIEW.md) | [.docx](https://raw.githubusercontent.com/wshallwshall/secure-development-standards/main/docs/standards/word/OVERVIEW.docx) |
