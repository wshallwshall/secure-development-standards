...
it. [How to adopt this](#how-to-adopt-this) sets the rest of the order,
[How this page is organized](#how-this-page-is-organized) is the map, and
...
this is a producer's disclosure path, not an incident response program. Incidents are generated by
running the software. The coverage table below records the catalog's incident-response family as not
addressed here and gives the reason, and nothing in this subsection changes it.
...
One entry filled in, using this document's own worked case from
[section 4](#4-review-and-what-to-do-when-there-is-no-second-reviewer). Illustrative only:

| Field | Entry |
|---|---|
| The control not met, and the date the risk was accepted | Peer review by a second reviewer, accepted on the date this entry was written |
