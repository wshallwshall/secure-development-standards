...
REGENERATE WITH (from docs/standards/, needs pandoc):
    ...
    for f in OVERVIEW CODE-QUALITY SECURE-DEVELOPMENT AI-ASSISTED-DEVELOPMENT DEPENDENCY-INTEGRITY REVIEW-DEPTH ADOPTING-THESE STANDARDS-LANDSCAPE STANDARDS-REFERENCE; do
